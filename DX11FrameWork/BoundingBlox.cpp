...
//BoundingBlox::BoundingBlox(ID3D11Device* device, float x, float y, float z, wstring name, float scale)
//
//{
//	_angle = 0;
////	_mesh = mesh;
...
//	_type = L"Box";
//	_scale = scale;
////	_center = XMVECTOR(0.0f,0.0f,0.0f);
//	CreateBoundingBlox();
//}
//
////-----------------------------------------------------------------------------
...
////-----------------------------------------------------------------------------
//BoundingBlox::~BoundingBlox(void)
//{
////	SAFE_RELEASE(_mesh);
//}
//
...
////-----------------------------------------------------------------------------
//void BoundingBlox::CreateBoundingBlox(void)
//{
///*
//
//
...
//	_oobCornerVertices[0] = XMVECTOR(_boxMin.x, _boxMin.y, _boxMin.z);
//	_oobCornerVertices[1] = XMVECTOR(_boxMax.x, _boxMin.y, _boxMin.z);
//	_oobCornerVertices[2] = XMVECTOR(_boxMin.x, _boxMax.y, _boxMin.z);
//	_oobCornerVertices[3] = XMVECTOR(_boxMax.x, _boxMax.y, _boxMin.z);
//	_oobCornerVertices[4] = XMVECTOR(_boxMin.x, _boxMin.y, _boxMax.z);
//	_oobCornerVertices[5] = XMVECTOR(_boxMax.x, _boxMin.y, _boxMax.z);
//	_oobCornerVertices[6] = XMVECTOR(_boxMin.x, _boxMax.y, _boxMax.z);
//	_oobCornerVertices[7] = XMVECTOR(_boxMax.x, _boxMax.y, _boxMax.z);
//
...
////-----------------------------------------------------------------------------
//HRESULT BoundingBlox::Render(void)
//{
//	/*
//	XMMATRIXRotationY(&_rotationMatrix, _angle);
...
////-----------------------------------------------------------------------------
//void BoundingBlox::UpdateBoundingShape(XMMATRIX& worldMatrix)
//{
//	/*
...
////-----------------------------------------------------------------------------
//bool BoundingBlox::IsIntersecting(SceneNode* otherShape)
//{
//	/*
//	 _box1 = this;
...
////-----------------------------------------------------------------------------
//bool BoundingBlox::CheckDirectionX(void)
//{
//	/*
...
//// Desc: Checks which side we are colliding with
////-----------------------------------------------------------------------------
//bool BoundingBlox::CheckDirectionZ(void)
//{
//	/*
...
//
////Accessors
//XMFLOAT3 BoundingBlox::GetFrontLeftVector(void)const
//{
////	return XMVECTOR(_boxMax.x - _width,_boxMax.y - _height,_boxMax.z);
////	return XMFLOAT3(_boxMax.x - _width,_boxMax.y - _height,_boxMax.z);
//	return XMFLOAT3(0.0f,0.0f,0.0f);
//}
//
//XMFLOAT3 BoundingBlox::GetFrontMidVector(void)const
//{
////	return XMFLOAT3(_boxMax.x - (_width/2),_boxMax.y - _height,_boxMax.z);
//	return XMFLOAT3(0.0f,0.0f,0.0f);
//}
//
//XMFLOAT3 BoundingBlox::GetFrontRightVector(void)const
//{
////	return XMFLOAT3(_boxMax.x,_boxMax.y - _height,_boxMax.z);
//	return XMFLOAT3(0.0f,0.0f,0.0f);
//}
//
//XMFLOAT3 BoundingBlox::GetRearMidVector(void)const
//{
////	return XMFLOAT3(_boxMin.x + (_width/2),_boxMax.y - _height,_boxMin.z);
//	return XMFLOAT3(0.0f,0.0f,0.0f);
//}
//
//XMFLOAT3 BoundingBlox::GetBoxMax(void)
//{
//	return _boxMax;
//}
//
//XMFLOAT3 BoundingBlox::GetBoxMin(void)
//{
//	return _boxMin;
//}
