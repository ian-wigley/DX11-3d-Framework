...
//BoundingSphere::BoundingSphere(ID3D11Device* device, float x, float y, float z, wstring name, float scale)
//{
//	_x = x;
//	_y = y;
//	_z = z;
...
//
//		XMVECTOR delta = sphere1->GetCenter() - sphere2->GetCenter();
//
...
//
//		XMVECTOR boxMin = _box1->GetBoxMin();
//		XMVECTOR boxMax = _box1->GetBoxMax();
//
...
////-----------------------------------------------------------------------------
//void BoundingSphere::UpdateBoundingShape(XMMATRIX* MatWorld)
//{
//	/*
//	_x = MatWorld->_41;
//	_y = MatWorld->_42;
...
//
////Accessors
//XMVECTOR BoundingSphere::GetCenter(void)
//{
//	return _center;
//}
//
